...
import cover_img from './img/machine_learning.png'
    ...
    return (
        ...
        <div className="mainContent">
            ...
            <div className="block">
                ...
                <p style={{marginBottom:'0px'}}> I feed the data I gather from <i>Python Data Manipulation</i> to a machine learning algorithm that I am still developing.</p>
